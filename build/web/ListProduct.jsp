<%-- 
    ...
    Created on : Mar 13, 2021, 9:21:33 AM
    Author     : mynameis
--%>
                            ...
                            <div class="col-sm-4 lg-2">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <!-- lấy id cho product detail-->               <a href="prodetail?pid=${o.id}" class="btn btn-primary">giá:${o.price}$</a>
                                        <a href="cart?pid=${o.id}" class="btn btn-primary">giỏ hàng</a>
