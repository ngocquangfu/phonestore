        ...
        <div class="main">
            <div class="container">
                <section class="jumbotron text-center">
                    <div class="container">
                        <h1 class="jumbotron-heading">PAYMENT PRODUCT</h1>
                    </div>
                </section>
            </div>
            <div class="container">
                                        ...
                                        <form action="buy" method="get">
                                            <div class="col-lg-6">
                                                ...
                                                <div class="md-form md-outline mb-0" style="width: 400px">
                                                    ...
                                                    <input type="text" name="fullname" class="form-control mb-0 mb-lg-2">

                                                </div>
                                                <div class="md-form md-outline mb-0"style="width: 400px">
                                                    <label for="firstName">Số Điện Thoại</label>
                                                    <input type="text" name="sdt" class="form-control mb-0 mb-lg-2">

                                                </div>

                                                <div class="md-form md-outline mb-0"style="width: 400px">
                                                    <label for="firstName">Địa Chỉ</label>
                                                    <input type="text" name="address" class="form-control mb-0 mb-lg-2">

                                                </div>
                                                <div class="md-form md-outline mb-0"style="width: 400px">
                                                    <label for="firstName">Email</label>
                                                    <input type="email" name="email" class="form-control mb-0 mb-lg-2">
                                                ...
                                                <div class="md-form md-outline" style="padding-top  :20px;padding-bottom:20px ">
                                                    <select class="form-select" aria-label="Default select example" name="bank">
                                                        <option selected value="0">TechComBank</option>
                                                        <option value="1">BIDV</option>
                                                        <option value="2">VietComBank</option>
                                                        <option value="3">TP Bank</option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="md-form md-outline  text-center"id="button-complete">
                                                    <button class="btn btn-lg btn-block btn-success text-uppercase text-center"style="margin-top:20px" type="submit">Complete payment</button>
                                                </div>
                                            </div>
